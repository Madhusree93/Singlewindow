(function ($) {
    ...
    jQuery(document).ready(function($){
		...
		$('.hero-slider').owlCarousel({
			...
			nav: true,
			autoplay: true,
			navText: ["<img src='public/website/assets/img/icons/arrow-prev.png'>","<img src='public/website/assets/img/icons/arrow-next.png'>"],
		...
		$('.hero-slider-two').owlCarousel({
			...
			dots: false,
			nav: true,
			navText: ["<img src='public/website/assets/img/icons/arrow-prev-short.png'>","<img src='public/website/assets/img/icons/arrow-next-short.png'>"],
			responsiveClass: true,
			items: 1,
		});
		...
		$('.modal').on('hide.bs.modal', function(e) {    
		    ...
		    var src = $if.attr("src");
		    $if.attr("src", 'https://themejunction.net/empty.html');
		    $if.attr("src", src);
		});
	    ...
	    $('.testimonial-carousel-three').owlCarousel({
		    ...
		    dots: false,
			nav: true,
			navText: ["<img src='https://icare-haldia.org/public/website/assets/img/icons/arrow-prev-short.png'>","<img src='https://icare-haldia.org/public/website/assets/img/icons/arrow-next-short.png'>"],
		});
