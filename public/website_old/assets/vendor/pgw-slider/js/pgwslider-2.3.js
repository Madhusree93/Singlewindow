    ...
    $.fn.pgwSlider = function(options) {
        ...
        var setup = function() {
            ...
            if (pgwSlider.config.displayControls && pgwSlider.slideCount > 1) {
                pgwSlider.plugin.find('.ps-current').prepend('<span class="ps-prev"><img src="https://icare-haldia.org/public/website/assets/img/icons/arrow-prev-small.png" /></span>');
                pgwSlider.plugin.find('.ps-current').append('<span class="ps-next"><img src="https://icare-haldia.org/public/website/assets/img/icons/arrow-next-small.png" /></span>');
